...
public class NormalAlertDialog implements View.OnClickListener {
    ...
    private void initDialog(Builder builder) {
        ...
        if (builder.getOnCancelListener() != null){
            mDialog.setOnCancelListener(builder.getOnCancelListener());
        }
        ...
        mTitle.setBackgroundResource(builder.getTitleBackgroundRes());
        mTitle.setTextColor(mContext.getResources().getColor(builder.getTitleTextColor()));
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            titleBackgroundRes = R.drawable.shape_dialog_title_bg;
        ...
        public Builder setTitleText(String titleButtonText) {
            this.titleText = titleButtonText;
            return this;
        }
        ...
        public Builder setTitleBackgroundRes(int titleBackgroundRes){
