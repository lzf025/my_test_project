...
public class PreferenceManager {
    ...
    public static float getFloat(final Context context, final String key, final float pValue) {
        return PreferenceManager.getSharedPreferences(context).getFloat(key,pValue);
    }
