package com.ggxueche.utils.openudid;
 ...
 * <service android:name="com.wanda.sdk.openudid.OpenUDIDService">
 *     <intent-filter>
...
public class OpenUDIDManager implements ServiceConnection {
	...
	private void startService() {
		if (mMatchingIntents.size() > 0) { //There are some Intents untested
            ...
            i.setComponent(new ComponentName("com.ecar.student", servInfo.name));
