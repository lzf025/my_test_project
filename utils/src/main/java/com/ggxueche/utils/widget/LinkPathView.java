...
/**
 * 画板
 * Created by likunyang on 2017/6/6.
 */

public class LinkPathView extends View {
    ...
    public LinkPathView(Context context) {
        super(context);
        init(context);
    }

    public LinkPathView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LinkPathView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(Context context) {
        ...
        mPaintWidth = mContext.getResources().getDimensionPixelSize(R.dimen.y10);
        //设置抗锯齿
     ...
     * @throws IOException
     */
    public String saveToBase64() throws IOException {
